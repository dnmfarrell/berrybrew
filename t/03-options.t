...
like $o, qr|download_url:.*http://strawberryperl.com/releases.json|, "download_url ok";
like $o, qr/windows_homedir:.*false/, "windows_homedir ok";
like $o, qr/custom_exec:.*false/, "custom_exec ok";
